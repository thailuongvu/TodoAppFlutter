...
class UpcomingTasksScreen extends ConsumerWidget {
  static UpcomingTasksScreen builder(BuildContext context,GoRouterState state)=> const UpcomingTasksScreen();
                ...
                color:colors.primary,
                  child:  Column(
                    ...
                    children: [
                      ...
                      const Gap(10),
                      const DisplayWhiteText(text:'Todo App Upcoming',
                        fontSize: 40,
                         ),
  ...
  List<Task> _inCompletedTasks(List<Task> tasks){
    final List<Task> filteredTask = [];
    for(var task in tasks){
      final isTaskToday =Helpers.isTaskUpcoming(task);
